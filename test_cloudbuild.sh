...
--substitutions=_RSA_PRIVATE="${RSA_PRIV}",_RSA_PUBLIC="${RSA_PUB}",\
_DEVICE_ID="raspberrypi4",_TARGET_HOSTNAME="raspberrypi4",\
_WPA_ESSID="silverapple",_WPA_PASSWORD="Y34rz3r0",_WPA_COUNTRY="SE",_ENABLE_SSH="1",\
_FIRST_USER_NAME="teknoir",_FIRST_USER_PASS="raspberry",_NAMESPACE="anders"
